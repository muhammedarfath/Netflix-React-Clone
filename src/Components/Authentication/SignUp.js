...
function SignUp() {
    ...
    const onSubmit = async ({ email, password,phone,name }) => {
      if (parsedUser) {
        toast("USER IS ALREADY EXISTS PLEASE LOGOUT",
        {
          icon: '👏',
          style: {
            borderRadius: '10px',
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            >
              ...
              <label className="inline-block w-full">
                  ...
                  />
                  {errors.name && (
                    <p className="p-1 text-[13px] font-light text-orange-500">Please enter a valid name.</p>
                  )}
                </label>
                <label className="inline-block w-full">
                  <input
                ...
                <label className="inline-block w-full">
                  ...
                  />
                  {errors.phone && (
                    <p className="p-1 text-[13px] font-light text-orange-500">Please enter a valid phone number.</p>
                  )}
                </label>
                <label className="inline-block w-full">
                  <input
